# payroll_with_end.py
# Python 3 — paste into a new file and run in Visual Studio 2022 terminal
...
def input_with_end(prompt_text):
    """
    Read input and treat 'End' (case-insensitive) as a quit request.
    Returns the raw string (never None). If the user confirms quit, QuitRequested is raised.
    """
